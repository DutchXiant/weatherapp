    ...
    <div className='flex bg-[#232528] text-center gap-3 shadow-xl'>
      <div className='flex w-[70%] m-auto lg:justify-around md:justify-around xs:flex-col md:flex-row lg:flex-row items-center p-5'>
        ...
        <div className='flex gap-2 items-center'>
          ...
          <Link href="/afvallen"><button  className="bg-[#FFA400] px-5 py-1 rounded-lg flex flex-col items-center justify-center shadow-md"><h1 className='font-bold'>Aankomen</h1><img className='w-[50px]' src="https://i.ibb.co/Dwqs6N5/muscle-svgrepo-com-1.png"></img></button></Link>
        </div>
        </div>
    </div>
  )
